...
sensores = ["combustível", "gasolina", "óleo", "freio", "freios", "temperatura", "motor", "pressão", "pneu", "dianteiro", "traseiro", "esquerdo", "dreito"]
    ...
    def verifica_n(fala):
        if set(fala.split()).intersection(sensores):
            ...
            if 'temperatura' in fala and 'motor' in fala:
                windows_speak.Speak(
                    'O motor esta à ' + str(sensors('temperature')) + ' graus celsius.')
            if 'odometro' in fala or 'andei' in fala:
                windows_speak.Speak(
                    'O carro já rodou ' + str(sensors('odometer')) + ' quilometros.')
            if 'temperatura' in fala and 'pneu' in fala and 'direito' in fala and 'dianteiro' in fala:
                windows_speak.Speak('O pneu dianteiro direito está á ' + str(
                    sensors('rfTireTemp')) + ' graus celsius.')
            if 'temperatura' in fala and 'pneu' in fala and 'direito' in fala and 'traseiro' in fala:
                windows_speak.Speak('O pneu traseiro direito está á ' + str(
                    sensors('rrTireTemp')) + ' graus celsius.')
            if 'temperatura' in fala and 'pneu' in fala and 'esquerdo' in fala and 'dianteiro' in fala:
                windows_speak.Speak('O pneu dianteiro esquerdo está á ' + str(
                    sensors('lfTireTemp')) + ' graus celsius.')
            if 'temperatura' in fala and 'pneu' in fala and 'esquerdo' in fala and 'traseiro' in fala:
                windows_speak.Speak('O pneu traseiro esquerdo está á ' + str(
                    sensors('rlTireTemp')) + ' graus celsius.')
            if 'pressão' in fala and 'pneu' in fala and 'direito' in fala and 'dianteiro' in fala:
                windows_speak.Speak('O pneu dianteiro direito tem ' + str(
                    sensors('rfTirePressure')) + ' P S I.')
            if 'pressão' in fala and 'pneu' in fala and 'direito' in fala and 'traseiro' in fala:
                windows_speak.Speak('O pneu traseiro direito tem ' + str(
                    sensors('rrTirePressure')) + ' P S I.')
            if 'pressão' in fala and 'pneu' in fala and 'esquerdo' in fala and 'dianteiro' in fala:
                windows_speak.Speak('O pneu dianteiro esquerdo tem ' + str(
                    sensors('lfTirePressure')) + ' P S I.')
            if 'pressão' in fala and 'pneu' in fala and 'esquerdo' in fala and 'traseiro' in fala:
                windows_speak.Speak('O pneu traseiro esquerdo tem ' + str(
                    sensors('rlTirePressure')) + ' P S I.')
        else:
